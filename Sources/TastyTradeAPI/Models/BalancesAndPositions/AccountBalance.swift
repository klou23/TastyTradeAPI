...
/// Data model for storing current account balance
///
/// This type is returned from ``TastyAPI/balances(accountNumber:currency:)``.
///
...
public struct AccountBalance: Codable {
    ...
    public var regTMarginRequirement: String?
    public var futuresOvernightMarginRequirement: String?
    public var futuresIntradayMarginRequirement: String?
    public var maintenanceExcess: String?
    public var pendingMarginInterest: String?
    public var apexStartingDayMarginEquity: String?
    public var buyingPowerAdjustment: String?
    public var buyingPowerAdjustmentEffect: String?
    public var effectiveCryptocurrencyBuyingPower: String?
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case regTMarginRequirement = "reg-t-margin-requirement"
        case futuresOvernightMarginRequirement = "futures-overnight-margin-requirement"
        case futuresIntradayMarginRequirement = "futures-intraday-margin-requirement"
        case maintenanceExcess = "maintenance-excess"
        case pendingMarginInterest = "pending-margin-interest"
        case apexStartingDayMarginEquity = "apex-starting-day-margin-equity"
        case buyingPowerAdjustment = "buying-power-adjustment"
        case buyingPowerAdjustmentEffect = "buying-power-adjustment-effect"
        case effectiveCryptocurrencyBuyingPower = "effective-cryptocurrency-buying-power"
