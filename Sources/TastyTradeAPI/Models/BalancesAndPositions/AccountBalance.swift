...
struct AccountBalance: Codable {
    ...
    var regTMarginRequirement: String?
    var futuresOvernightMarginRequirement: String?
    var futuresIntradayMarginRequirement: String?
    var maintenanceExcess: String?
    var pendingMarginInterest: String?
    var apexStartingDayMarginEquity: String?
    var buyingPowerAdjustment: String?
    var buyingPowerAdjustmentEffect: String?
    var effectiveCryptocurrencyBuyingPower: String?
